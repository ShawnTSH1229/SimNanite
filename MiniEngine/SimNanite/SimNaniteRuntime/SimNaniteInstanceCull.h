...
class CInstanceCullPass_Deprecated
{
public:
...
private:
	...
	std::vector<SNaniteInstanceSceneData_Depracated> m_nanite_instance_scene_data;

	StructuredBuffer m_ins_scene_data_gpu;
	StructuredBuffer m_culled_ins_scene_data_gpu;
	ByteAddressBuffer m_culled_instance_num;

	SCullingParameters_Deprecated m_cull_parameters;
