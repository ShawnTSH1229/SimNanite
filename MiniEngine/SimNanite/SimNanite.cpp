...
class SimNanite : public GameCore::IGameApp
{
public:
...
void SimNanite::Startup( void )
{
//#if SIMNANITE_CODE
//    SBuildCluster total_mesh_cluster;
//    bool load_result = LoadObj(std::string("H:/SimNanite/MiniEngine/SimNanite/teapot/teapot.obj"), &total_mesh_cluster);
//    //bool load_result = LoadObj(std::string("H:/SimNanite/MiniEngine/SimNanite/erato/erato.obj"), &input_mesh_data);
//
//    CSimNaniteBuilder nanite_builder;
//    CSimNaniteMeshResource nanite_resource;
//    nanite_builder.Build(total_mesh_cluster, nanite_resource);
//#endif
...
void SimNanite::Update( float deltaT )
{
...
void SimNanite::RenderScene( void )
{
